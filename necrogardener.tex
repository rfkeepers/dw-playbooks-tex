...
\pageOne
    ...
    {
        \looks
        \looksOption{EYES}{Blood red, Vivid green, or Yellow pus}
    ...
    % Starting Moves
    {
        ...
        \move[x]{Blacksoil}
            ...
            \gapSm
            \opt{You and your allies will risk danger from \blank{2.5}.}
            \gapSm
            \opt{First you must enrich the soil by fertilizing it with \blank{2.5}.}
            \gapSm
            \opt{The growth will drain away all \blank{2.5} nearby.}
            \gapSm
...
\pageTwo
    % left-hand column (bonds, alignment, gear)
    {
        ...
        \gap
        \alignmentOption{Chaotic}{Permit an unsavory creature to live as long as it doesn’t intentionally harm you.}\gap
        \diyMove{5}
        \load\gap
        \gear
        \adventuringGear
