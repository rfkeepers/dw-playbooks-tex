...
\pageOne
    ...
    {
        \looks
        \looksOption{EYES}{Unwavering, Hidden, or Light-catching glasses}
        \looksOption{HAIR}{Clean cut, Rougeish, or Long and greasy}
        \looksOption{BODY}{Built, Lithe, or Nearly skeletal}
        \looksOption{CLOTHES}{Rich, Self-made, or Street casual}
...
\pageTwo
    % left-hand column (bonds, alignment, gear)
    {
        ...
        \gap
        \alignmentOption{Evil}{Go to any lengths to stop evil.}\gap
        \diyMove{5}
        \load\gap
        \gear
        \adventuringGear
        \gearOption{\important{Leather Armor} (1 armor, \tag{worn}, 1 weight)}
        \gearOption{\important{Arm-mounted Grappling Bow} (\tag{worn},\\1 weight)}\gap\\
